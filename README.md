...
- [8. C++ Project](#cpp)
  - [8.1 Autogenerated Folders](#cpp-auto-folders)
    - [8.1.1 Source Folder](#cpp-source)
    - [8.1.2 Config Folder](#cpp-config)
    - [8.1.3 Binaries and Build Folder](#cpp-build)
    - [8.1.4 Intermediate and Saved Folders](#cpp-inter-saved)
      - [8.1.4.1 Logs](#cpp-logs)
      - [8.1.4.2 Backups](#cpp-backups)
  - [8.2 Autogenerated Files](#cpp-auto-files)
    - [8.2.1 .uproject File](#cpp-uproj)
    - [8.2.2 Modules Rules File (.build.cs files)](#cpp-build-cs)
    - [8.2.3 UnrealBuildTool Target Files](#cpp-target)
  - [8.3 Source Directory Structure](#cpp-structure)
    - [8.3e1 Example of Source Directory Structure](#8.3e1)
  - [8.4 Modules (W.I.P)](#cpp-modules)
...
<a name="8"></a>
<a name="cpp"></a>
## 8. C++ Project Structure

This section will focus on C++ Project folder structure and files. When possible, style rules conform to [Epic's Coding Standard.](https://dev.epicgames.com/documentation/en-us/unreal-engine/epic-cplusplus-coding-standard-for-unreal-engine)

Other sources includes:
- [Learning C++ in Unreal Engine: Project Structure](https://medium.com/tokyopixels/learning-c-in-unreal-engine-91fe3067ec61) by [Julien Hora](https://medium.com/@rmnsnc)

<a name="cpp-auto-folders"></a>
### 8.1 Autogenerated Folders
Several folders are generated when a C++ Unreal Project is created.  

<a name="cpp-source"></a>
#### 8.1.1 Source Folder
```ProjectName/Source```  

Contains all the project specifics C++ source code files. See [Project Folder Structure](#cpp-structure)

NOTE: Modules files are NOT located inside Source folder. See [Modules section](#cpp-modules)
...
<a name="cpp-build"></a>
#### 8.1.3 Build and Binaries Folders
```ProjectName/Binaries``` | ```ProjectName/Build```
...
- Binaries: Stores the compiled binary files for your project.
- Build: Contains build configuration files for different platforms.

<a name="cpp-inter-saved"></a>
#### 8.1.4 Intermediate and Saved Folders  

```ProjectName/Intermediate``` | ```ProjectName/Saved```
...
These folders are usually excluded from the version control repository and their content is generated by each client.

- Intermediate: Contains intermediate and temporary files generated during the build process.
- Saved: Stores saved data, logs, and backup files.

<a name="cpp-auto-files"></a>
### 8.1 Autogenerated Files

<a name="#cpp-uproj"></a>
#### 8.1.1 uproject File
```ProjectName/ProjectName.uproject```  

The primary project file that contains metadata about your project. You can open this file with your IDE or Unreal Engine.

<a name="#cpp-build-cs"></a>
#### 8.1.2 Module Rules File
```ProjectName/Source/ProjectName/ProjectName.Build.cs```  

Defines the rules and dependencies for your project’s modules.

<a name="#cpp-target"></a>
#### 8.1.3 UnrealBuildTool Target Files
```ProjectName/Source/ProjectName.Target.cs```  



<a name="#cpp-structure"></a>
### 8.3 Source Directory Structure

<a name="8.3e1"><a>
### 8.3e1 Example C++ Source Folder Project Structure
<pre>
|-- Source
    ...
    |   |   |-- Gizmos
    |   |   |-- LevelDesignTools
    |   |-- GenericShooterEditor.Build.cs
    |-- <a href="#8.3.3">ThirdPartyModule</a>
    |   |-- Private
    |   |   |-- AwesomeFolder
    |   |-- Public
    |   |   |-- AwesomeFolder
    |   |-- ThirdPartyModule.Build.cs
</pre>
